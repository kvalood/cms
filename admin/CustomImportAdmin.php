...
class CustomImportAdmin extends Simpla
{	
	...
	public function fetch()
	{
        ...
        elseif($this->request->method('post') AND $this->request->method('post') == 'save')
        {
            ...
            $this->settings->custom_fields = $options;
        }

        $custom_fields = json_decode($this->settings->custom_fields);
        $this->design->assign('custom_fields', $custom_fields);

		return $this->design->fetch('custom_import.tpl');
	}
