	...
	{		
		...
		if($this->request->method('post'))
		{
			...
			switch($this->request->post('action'))
			{
                ...
                case 'ymarket':
                {
                    $this->products->update_product($ids, array('ymarket'=>1));
                    break;
                }
                case 'ymarket_no':
                {
                    $this->products->update_product($ids, array('ymarket'=>0));
                    break;
                }
                case 'google':
                {
                    $this->products->update_product($ids, array('google'=>1));
                    break;
                }
                case 'google_no':
                {
                    $this->products->update_product($ids, array('google'=>0));
                    break;
                }
			    case 'move_to_page':
			    {
