<?php /* Smarty version 3.1.24, created on 2015-06-15 21:13:12
         compiled from "admin/design/html/tags.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:3825557eb3485050b3_84352032%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38a6509e5553c62074c3a02e7f255e1fa8f00fc2' => 
    array (
  ...
  'nocache_hash' => '3825557eb3485050b3_84352032',
  'variables' => 
  array (
    'tags' => 0,
    'tag' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_557eb3485e79e9_29296947',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_557eb3485e79e9_29296947')) {
function content_557eb3485e79e9_29296947 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '3825557eb3485050b3_84352032';
?>
...
'},
	...
	function close_edit()
	{
		$('#form_list #edit_form').remove();
		$('#form_list').find('.item_line:hidden').css('display','block');
	}
...
'},
	...
	$(document).on('click', '.add_object', function(){
		close_edit();
		edit_form = $('#edit_form').clone(true);
		$('#form_list').append(edit_form.addClass('act')).find(':input').val('');
	});
});
