<?php /* Smarty version 3.1.24, created on 2015-06-10 03:01:06
         compiled from "admin/design/html/settings.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1323555771bd22e34b0_46323911%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ad2df211d4dea50455c08c4309d51086f903d20c' => 
    array (
  ...
  'nocache_hash' => '1323555771bd22e34b0_46323911',
  'variables' => 
  array (
    'message_success' => 0,
    'message_error' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_55771bd2734d47_46663068',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_55771bd2734d47_46663068')) {
function content_55771bd2734d47_46663068 ($_smarty_tpl) {
if (!is_callable('smarty_function_math')) require_once 'D:/OpenServer/domains/cms/Smarty/libs/plugins/function.math.php';

$_smarty_tpl->properties['nocache_hash'] = '1323555771bd22e34b0_46323911';
...
" /></li>
        ...
        <div id="board_column_right">
			<div class="block">
				<h2>Оповещения</h2>
				<ul>
					<li><label class=property>Оповещение о заказах</label><input name="order_email" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->order_email, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
					<li><label class=property>Оповещение о комментариях</label><input name="comment_email" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->comment_email, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
					<li><label class=property>Обратный адрес оповещений</label><input name="notify_from_email" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->notify_from_email, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				</ul>
			</div>
