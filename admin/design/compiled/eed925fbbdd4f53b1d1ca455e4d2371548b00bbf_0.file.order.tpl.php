<?php /* Smarty version 3.1.24, created on 2015-06-15 18:34:37
         compiled from "admin/design/html/order.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:18072557e8e1daff7e1_60693491%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eed925fbbdd4f53b1d1ca455e4d2371548b00bbf' => 
    array (
  ...
  'nocache_hash' => '18072557e8e1daff7e1_60693491',
  'variables' => 
  array (
    'order' => 0,
    'message_error' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_557e8e1dd70873_20064362',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_557e8e1dd70873_20064362')) {
function content_557e8e1dd70873_20064362 ($_smarty_tpl) {
...
if (!is_callable('smarty_function_math')) require_once 'D:/OpenServer/domains/cms/Smarty/libs/plugins/function.math.php';

$_smarty_tpl->properties['nocache_hash'] = '18072557e8e1daff7e1_60693491';
...
'>
                    ...
                    <li>
                        <label class=property>Ваше примечание <br/> (не видно пользователю)</label><textarea name="note"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->note, ENT_QUOTES, 'UTF-8', true);?>
</textarea>
                    </li>
...
?>
        ...
        <div id="board_column_right">
            <div class="block">
                <h2>Детали заказа</h2>
                <ul>
                    <li><label class=property>Номер заказа</label><input class="name" name=name type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->id, ENT_QUOTES, 'UTF-8', true);?>
"/></li>

                    <li>
                        <label class=property>Дата</label><input class="name" name=date type="text" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['order']->value->date,'%Y/%m/%d %H:%M');?>
"/>
                    </li>
...
$(function() {
    ...
    $('input[name="date"]').datetimepicker({
        value: '<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['order']->value->date,'%Y/%m/%d %H:%M');?>
'
    });
