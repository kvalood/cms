                        ...
                        <ul>
                            <li>
                                ...
                                <select name="sorting_method">
                                    <option value="position" {if $settings->sorting_method|escape == 'position'}selected="select"{/if}>позиции</option>
                                    <option value="name" {if $settings->sorting_method|escape == 'name'}selected="select"{/if}>названию</option>
                                    <option value="created" {if $settings->sorting_method|escape == 'created'}selected="select"{/if}>дате создания</option>
                                    <option value="brand" {if $settings->sorting_method|escape == 'brand'}selected="select"{/if}>бренду</option>
                                    <option value="price" {if $settings->sorting_method|escape == 'price'}selected="select"{/if}>цене</option>
                                    <option value="likes" {if $settings->sorting_method|escape == 'likes'}selected="select"{/if}>лайкам</option>
                                </select>

                                <select name="sort_product_type">
                                    <option value="DESC" {if $settings->sort_product_type|escape == 'DESC'}selected="select"{/if}>убыванию</option>
                                    <option value="ASC" {if $settings->sort_product_type|escape == 'ASC'}selected="select"{/if}>возрастанию</option>
                                </select>
                            </li>
                        </ul>
