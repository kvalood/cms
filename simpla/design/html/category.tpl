                ...
                <ul>
                    <li>
                        <select name="order_by">
                            <option value="" {if empty($settings->order_by)}selected="select"{/if}>-не выбрано-</option>
                            <option value="position" {if $category->order_by|escape == 'position'}selected="select"{/if}>позиции</option>
                            <option value="name" {if $category->order_by|escape == 'name'}selected="select"{/if}>названию</option>
                            <option value="created" {if $category->order_by|escape == 'created'}selected="select"{/if}>дате создания</option>
                            <option value="brand" {if $category->order_by|escape == 'brand'}selected="select"{/if}>бренду</option>
                            <option value="price" {if $category->order_by|escape == 'price'}selected="select"{/if}>цене</option>
                            <option value="likes" {if $category->order_by|escape == 'likes'}selected="select"{/if}>лайкам</option>
                        </select>
                    </li>
                    <li>
                        <select name="sort_order">
                            <option value="" {if empty($category->sort_order)}selected="select"{/if}>-не выбрано-</option>
                            <option value="desc" {if $category->sort_order|escape == 'desc'}selected="select"{/if}>убыванию</option>
                            <option value="asc" {if $category->sort_order|escape == 'asc'}selected="select"{/if}>возрастанию</option>
                        </select>
                    </li>
                </ul>
