...
<head>
    ...
    {* jQuery *}
    <script src="/simpla/design/libs/jquery.2.2.4.min.js"></script>
    <script src="/simpla/design/js/jquery/jquery.form.min.js"></script>

    {* Bootstrap *}
    <script src="/simpla/design/libs/bootstrap/js/bootstrap.min.js"></script>
    <link href="/simpla/design/libs/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css" />

    {* Bootstrap multiselect *}
    <script src="/simpla/design/libs/bootstrap-select/bootstrap-select.min.js"></script>
    <script src="/simpla/design/libs/bootstrap-select/ajax-bootstrap-select.min.js"></script>
    <script src="/simpla/design/libs/bootstrap-select/locale/ajax-bootstrap-select.ru-RU.min.js"></script>
    <link href="/simpla/design/libs/bootstrap-select/bootstrap-select.min.css" rel="stylesheet" type="text/css" />

    {* Autocomplete *}
    <script src="/simpla/design/libs/autocomplete/jquery.autocomplete.min.js"></script>
    ...
    {* Date time picker *}
    <script src="/simpla/design/libs/datetimepicker/jquery.datetimepicker.full.min.js" type="text/javascript"></script>
    <link href="/simpla/design/libs/datetimepicker/jquery.datetimepicker.css" rel="stylesheet" type="text/css" />

    {* Ядро JS движка*}
    <script src="/simpla/design/js/core.js"></script>
        ...
        <div class="container">
            <div class="row">
                ...
                {if in_array('orders', $manager->permissions)}
                    <a href="index.php?module=Orderssimpla">Новых заказов <span class="green">{$new_orders_counter}</span></a>
                {/if}
                </div>
